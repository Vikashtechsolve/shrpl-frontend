...
const SaaviInfo: React.FC = () => {
  return (
    <div className="p-6 space-y-4">
        ...
        <div className="sm:w-1/2 p-5">
          <div className="text">
            ...
            <p className="text-gray-700">
              <strong className="text-[#8B2B06]">SHPRL Hotels and Resorts Private Limited</strong> is an emerging hospitality
              brand in India, founded by Deepak Dangi, a seasoned professional with over 13 years of
              experience in five-star hospitality. SHPRL Hotels is committed to redefining corporate
      ...
      <div>
        <h2 className="text-lg font-bold text-red-700 mb-2">Key Features of SHPRL Hotels</h2>
        <ul className="list-disc list-inside text-gray-700 space-y-2">
          ...
          <li>
            <strong className="text-[#8B2B06]">Strategic Locations:</strong> SHPRL Hotels are strategically
            located in business hubs and major cities, making them easily
            accessible for corporate clients.
          </li>
          <li>
            <strong className="text-[#8B2B06]">Sustainability:</strong> SHPRL Hotels emphasizes eco-friendly
            practices, ensuring operations contribute to a greener environment.
          </li>
          <li>
            <strong className="text-[#8B2B06]">Exceptional Guest Service:</strong> The team at SHPRL Hotels
      ...
      <div>
        ...
        <p className="text-gray-700">
          SHPRL Hotels is focused on expanding its presence across major cities
          in India, with plans to cater to international markets in the future.
          By combining industry expertise with modern trends, SHPRL Hotels aims
